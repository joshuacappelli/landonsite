    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 md:py-24">
          ...
          <div className="flex flex-col md:flex-row items-center gap-16 mb-24">
            ...
            <div className="md:w-2/3 space-y-8">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="px-6 py-3 bg-indigo-100 text-indigo-800 rounded-full text-sm font-medium hover:bg-indigo-200 transition-colors">
                  Adventure Seeker
                </span>
                <span className="px-6 py-3 bg-purple-100 text-purple-800 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors">
                  Photographer
                </span>
                <span className="px-6 py-3 bg-pink-100 text-pink-800 rounded-full text-sm font-medium hover:bg-pink-200 transition-colors">
                  Food Explorer
                </span>
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {quickFacts.map((fact) => (
                ...
                >
                  <h3 className="text-2xl font-semibold mb-4 text-indigo-700">{fact.title}</h3>
          ...
          {/* Call to Action */}
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 to-purple-600 p-12">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a 
                  href="#" 
                  className="group bg-white text-indigo-600 hover:bg-indigo-50 transition-all duration-300 px-6 py-3 rounded-full font-medium flex items-center gap-2 hover:scale-105"
                >
